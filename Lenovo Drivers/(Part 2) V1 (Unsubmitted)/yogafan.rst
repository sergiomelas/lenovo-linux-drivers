...
* **1. YOGA SERIES (8-bit Continuous / Discrete Logic)**
  - Yoga Pro 9i (83E2), Yoga Pro 7 (83DN, 83CV), Yoga Pro (Aura Edition)
...
::
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | MODEL       | FAMILY / SERIES   | OFFSET  | FULL ACPI OBJECT PATH          | WIDTH  | NMAX  | RMAX  | MULT |T_ms  |SLEW_s| Inertial Notes        |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | **1. YOGA SERIES**                                                                                                                               |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | 82N7        | Yoga 14cACN       | 0x06    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 0     | 5500  | 100  | 1000 | 4    | **[REFERENCE MODEL]** |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 83DN        | Yoga Pro 9i (16") | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FANS (Fan1) | 16-bit | 0     | 8000  | 1    | 1400 | 6    | High Inertia (65mm)   |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 83DN        | Yoga Pro 9i (16") | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FA2S (Fan2) | 16-bit | 0     | 8000  | 1    | 1400 | 6    | High Inertia (65mm)   |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 83KF        | Yoga Pro 7i Aura  | 0xFE    | \_SB.PC00.LPCB.EC0.FA1S (Fan1) | 8-bit  | 0     | 6000  | 100  | 1100 | 4    | Aura (PC00 Bus)       |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 83KF        | Yoga Pro 7i Aura  | 0xFE    | \_SB.PC00.LPCB.EC0.FA2S (Fan2) | 8-bit  | 0     | 6000  | 100  | 1100 | 4    | Aura (PC00 Bus)       |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 83E2        | Yoga Pro 7 (14.5")| 0xFE    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 0     | 6000  | 100  | 1100 | 4    | Standard Dual Fan     |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 83CV        | Yoga Slim 7 (14") | 0x06    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 0     | 5500  | 100  | 900  | 3    | Reduced Inertia       |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 82A2 / 82A3 | Yoga Slim 7       | 0x06    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 0     | 5500  | 100  | 900  | 3    | Low Inertia           |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 80V2 / 81C3 | Yoga 710/720      | 0x06    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 59    | 4500  | 0    | 1000 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 80S7        | Yoga 510          | 0x06    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 41    | 4500  | 0    | 1000 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 80JH        | Yoga 3 14         | 0x06    | \_SB.PCI0.LPC0.EC0.FAN0/.FANS  | 8-bit  | 80    | 5000  | 0    | 1000 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 20344       | Yoga 2 13         | 0xAB    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 8     | 4200  | 0    | 800  | 3    | Small Fan             |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 20191       | Yoga 13           | 0xF2/F3 | \_SB.PCI0.LPC0.EC0.FAN1/2      | 8-bit  | 0     | 5000  | 100  | 800  | 3    | Dual Small            |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | Legacy      | Yoga 11s          | 0x56    | \_SB.PCI0.LPC0.EC0.FAN0/.FANS  | 8-bit  | 80    | 4500  | 0    | 600  | 2    | Ultra-portable        |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | **2. XIAOXIN SERIES (PRC)**                                                                                                                      |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | 83JC / 83DX | Xiaoxin Pro 14/16 | 0xFE    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 80    | 5000  | 0    | 1000 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 83FD / 83DE | Xiaoxin Pro       | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FAN0/.FANS  | 8-bit  | 0     | 5000  | 100  | 1000 | 4    | Standard              |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | **3. LEGION SERIES**                                                                                                                             |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | Legion 9    | Legion 9i / Extr  | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FANS (Fan1) | 16-bit | 0     | 8000  | 1    | 1500 | 6    | High Inertia Heavy    |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | Legion 9    | Legion 9i / Extr  | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FA2S (Fan2) | 16-bit | 0     | 8000  | 1    | 1500 | 6    | High Inertia Heavy    |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | Legion 9    | Legion 9i / Extr  | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FA3S (Fan3) | 16-bit | 0     | 8000  | 1    | 1200 | 5    | Scaled Center Fan     |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 82WQ        | Legion 7i (Int)   | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FANS (Fan1) | 16-bit | 0     | 8000  | 1    | 1400 | 6    | Heavy Duty            |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 82WQ        | Legion 7i (Int)   | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FA2S (Fan2) | 16-bit | 0     | 8000  | 1    | 1400 | 6    | Heavy Duty            |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 82JW / 82JU | Legion 5 (AMD)    | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FANS (Fan1) | 16-bit | 0     | 6500  | 1    | 1300 | 5    | Gaming Mid-Inertia    |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 82JW / 82JU | Legion 5 (AMD)    | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FA2S (Fan2) | 16-bit | 0     | 6500  | 1    | 1300 | 5    | Gaming Mid-Inertia    |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | GeekPro     | GeekPro G5000/6k  | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FANS (Fan1) | 16-bit | 0     | 6500  | 1    | 1300 | 5    | Gaming Mid-Inertia    |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | **4. LOQ SERIES**                                                                                                                                |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | 82XV / 83DV | LOQ 15/16         | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FANS (Fan1) | 16-bit | 0     | 6500  | 1    | 1200 | 5    | Budget Gaming         |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 82XV / 83DV | LOQ 15/16         | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FA2S (Fan2) | 16-bit | 0     | 6500  | 1    | 1200 | 5    | Budget Gaming         |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | **5. IDEAPAD SERIES**                                                                                                                            |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | 81YM / 82FG | IdeaPad 5         | 0x06    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 0     | 4500  | 100  | 1000 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | Legacy      | IdeaPad Y580      | 0x06    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 35    | 4800  | 0    | 1100 | 4    | Heavier Legacy        |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 80SR / 80SX | IdeaPad 500S-13   | 0x06    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 44    | 5500  | 0    | 900  | 3    | Slim                  |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 80S1        | IdeaPad 500S-14   | 0x95    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 116   | 5000  | 0    | 1000 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 80TK        | IdeaPad 510S      | 0x06    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 41    | 5100  | 0    | 1000 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 80S9        | IdeaPad 710S      | 0x95/98 | \_SB.PCI0.LPC0.EC0.FAN1/2      | 8-bit  | 0     | 5200  | 100  | 900  | 3    | Slim                  |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | **6. FLEX SERIES**                                                                                                                               |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | 81X1        | Flex 5            | 0x06    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 0     | 4500  | 100  | 1000 | 4    | Standard              |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | **7. THINKPAD SERIES**                                                                                                                           |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | 20GJ / 20GK | ThinkPad 13       | 0x85    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 7     | 5500  | 0    | 800  | 3    | Compact               |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 1143        | ThinkPad E520     | 0x95    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 0     | 4200  | 100  | 1100 | 4    | Heavy Chassis         |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 3698        | ThinkPad Helix    | 0x2F    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 7     | 4500  | 0    | 700  | 2    | Tablet-hybrid         |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 20M7 / 20M8 | ThinkPad L380     | 0x95    | \_SB.PCI0.LPC0.EC0.FAN1        | 8-bit  | 0     | 4600  | 100  | 1000 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 20NR / 20NS | ThinkPad L390     | 0x95    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 0     | 5500  | 100  | 1000 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 2464 / 2468 | ThinkPad L530     | 0x95    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 0     | 4400  | 100  | 1100 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 2356        | ThinkPad T430s    | 0x2F    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 7     | 5000  | 0    | 1000 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 20AQ / 20AR | ThinkPad T440s    | 0x4E    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 7     | 5200  | 0    | 1000 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 20BE / 20BF | ThinkPad T540p    | 0x2F    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 7     | 5500  | 0    | 1100 | 4    | High Mass Fan         |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 3051        | ThinkPad x121e    | 0x2F    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 7     | 4500  | 0    | 600  | 2    | Small Fan             |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 4290        | ThinkPad x220i    | 0x2F    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 7     | 5000  | 0    | 800  | 3    | Compact               |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 2324 / 2325 | ThinkPad x230     | 0x2F    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 7     | 5000  | 0    | 800  | 3    | Compact               |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | **8. THINKBOOK SERIES**                                                                                                                          |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | 83AK        | ThinkBook G7      | 0x06    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 0     | 5400  | 100  | 1000 | 4    | Standard              |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | **9. V-SERIES**                                                                                                                                  |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | 81AX        | V330-15IKB        | 0x95    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 0     | 5100  | 100  | 1000 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | Legacy      | IdeaPad V580      | 0x95    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 0     | 5000  | 100  | 1100 | 4    | Robust                |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | **10. U-SERIES (LEGACY)**                                                                                                                        |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
  | 80KU        | U31-70            | 0x06    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 44    | 5500  | 0    | 900  | 3    | Slim                  |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | 80S1        | U41-70            | 0x95    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 116   | 5000  | 0    | 1000 | 4    | Standard              |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | Legacy      | U160              | 0x95    | \_SB.PCI0.LPC0.EC0.FAN0        | 8-bit  | 64    | 4500  | 0    | 600  | 2    | Small Fan             |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+------+------+-----------------------+
  | Legacy      | U330p/U430p       | 0x92    | \_SB.PCI0.LPC0.EC0.FAN0        | 16-bit | 768   | 5000  | 0    | 800  | 3    | Multi-Resol.          |
  +=============+===================+=========+================================+========+=======+=======+======+======+======+=======================+
...
Note 3: Dynamic parameters (TAU and SLEW) are calibrated against the reference
Yoga 14cACN (d=50mm). Fleet-wide estimates are derived by scaling the
mechanical time constant relative to fan diameter (d) based on the moment of
