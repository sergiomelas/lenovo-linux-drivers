...
The ``yogafan`` driver supports over 400 Lenovo models released between 2011
...
This driver covers 400 models—over 85% of Lenovo's consumer and ultra-portable
...
4. WMI COEXISTENCE & FILTERING (THE SELECTION):
   The hardware table has been strictly filtered by cross-referencing findings
   with the 'lenovo-wmi-other' driver. Models and interfaces natively supported
   via WMI GUIDs (such as modern Legion/LOQ series) have been excluded from
   this HAL description to ensure deterministic driver separation and prevent
   double-reporting.
