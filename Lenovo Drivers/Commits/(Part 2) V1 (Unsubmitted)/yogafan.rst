...
::
  ...
  +=============+===================+=========+================================+========+=======+=======+======+==========+==========+=======================+
  | MODEL       | FAMILY / SERIES   | OFFSET  | FULL ACPI OBJECT PATH          | WIDTH  | NMAX  | RMAX  | MULT | TAU (ms) | SLEW (s) | Inertial Notes        |
  +=============+===================+=========+================================+========+=======+=======+======+==========+==========+=======================+
  | **1. YOGA SERIES**                                                                                                                                       |
  +=============+===================+=========+================================+========+=======+=======+======+==========+==========+=======================+
  | 82N7        | Yoga 14cACN       | 0x06    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 0     | 5500  | 100  | 1000     | 4        | **[REFERENCE MODEL]** |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+----------+----------+-----------------------+
  | 83E2        | Yoga Pro 9i       | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FANS (Fan1) | 16-bit | 0     | 8000  | 1    | 1200     | 5        | High Inertia          |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+----------+----------+-----------------------+
  | 83E2        | Yoga Pro 9i       | 0xFE/FF | \_SB.PCI0.LPC0.EC0.FA2S (Fan2) | 16-bit | 0     | 8000  | 1    | 1200     | 5        | High Inertia          |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+----------+----------+-----------------------+
  | 83CV        | Yoga Pro 9 (Aura) | 0xFE    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 0     | 6000  | 100  | 1100     | 4        | Scaled                |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+----------+----------+-----------------------+
  | 83DN        | Yoga Pro 7        | 0xFE    | \_SB.PCI0.LPC0.EC0.FANS        | 8-bit  | 0     | 6000  | 100  | 1000     | 4        | Scaled                |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+----------+----------+-----------------------+
  ...
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+----------+----------+-----------------------+
  | 2191 / 20191| Yoga 13           | 0xF2/F3 | \_SB.PCI0.LPC0.EC0.FAN1/2      | 8-bit  | 0     | 5000  | 100  | 800      | 3        | Dual Small            |
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+----------+----------+-----------------------+
  ...
  +-------------+-------------------+---------+--------------------------------+--------+-------+-------+------+----------+----------+-----------------------+
  | Legacy      | U330p/U430p       | 0x92    | \_SB.PCI0.LPC0.EC0.FAN0        | 16-bit | 768   | 5000  | 0    | 800      | 3        | Multi-Resolution      |
  +=============+===================+=========+================================+========+=======+=======+======+==========+==========+=======================+
