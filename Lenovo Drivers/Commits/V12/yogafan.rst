...
The driver exposes the RLLag V12 physical filter parameters (time constant and slew-rate limit) in SI units (seconds),
...
The driver exposes the RLLag  physical filter parameters (time constant and slew-rate limit) in SI units (seconds), dynamically synchronizing them with the specific model's maximum RPM to ensure a consistent physical response across the entire Lenovo product stack.
...
82JW / 82JU | Legion 5 (AMD)    | 0xFE/0xFF | \_SB.PCI0.LPC0.EC0.FANS (Fan1)  | 16-bit | 0       | 6500   | 1
82JW / 82JU | Legion 5 (AMD)    | 0xFE/0xFF | \_SB.PCI0.LPC0.EC0.FA2S (Fan2)  | 16-bit | 0       | 6500   | 1
82WQ        | Legion 7i (Int)   | 0xFE/0xFF | \_SB.PCI0.LPC0.EC0.FANS (Fan1)  | 16-bit | 0       | 8000   | 1
82WQ        | Legion 7i (Int)   | 0xFE/0xFF | \_SB.PCI0.LPC0.EC0.FA2S (Fan2)  | 16-bit | 0       | 8000   | 1
82XV / 83DV | LOQ 15/16         | 0xFE/0xFF | \_SB.PCI0.LPC0.EC0.FANS (Fan1)  | 16-bit | 0       | 6500   | 1
82XV / 83DV | LOQ 15/16         | 0xFE/0xFF | \_SB.PCI0.LPC0.EC0.FA2S (Fan2)  | 16-bit | 0       | 6500   | 1
...
80S9        | Ideapad 710S      | 0x95/0x98 | \_SB.PCI0.LPC0.EC0.FAN1/2       |  8-bit | 72      | 5200   | 100
...
2191 / 20191| Yoga 13           | 0xF2/0xF3 | \_SB.PCI0.LPC0.EC0.FAN1/2       |  8-bit | 255     | 5000   | 0
...
1143 (E520) | ThinkPad E520     | 0x95      | \_SB.PCI0.LPC0.EC0.FAN0         |  8-bit | 100     | 4200   | 100
