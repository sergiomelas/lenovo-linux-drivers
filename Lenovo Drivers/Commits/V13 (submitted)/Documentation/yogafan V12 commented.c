...
/* Data Structures */                                                                           // Structural definitions
...
static const struct yogafan_config ideapad_8bit_reg6_cfg = {                                    // Config: Yoga 710/510s Register 0x06
	.multiplier = 100,                                                                      // 8-bit scale: Value * 100
	.fan_count = 1,                                                                         // Single fan path
	.paths = { "\\_SB.PCI0.LPC0.EC0.FAN0", NULL }                                           // Register 0x06 path
};                                                                                              // End reg6 config
...
/* Filter Logic */                                                                              // Smoothing algorithm
...
/* Sysfs Callbacks */                                                                           // HWMON Read Interface
...
/* Permission Handler */                                                                        // Attribute visibility
...
/* HWMON Metadata */                                                                            // Subsystem binding
...
/* Channel Definitions */                                                                       // Sensor configuration
...
/* Chip Info binding */                                                                         // Subsystem integration
...
/* DMI Quirk Table */                                                                           // Hardware identification
static const struct dmi_system_id yogafan_quirks[] = {                                          // The "ID Card" Database
	/* Specific Model Overrides (Matched first) */                                          // Match specific models before families
	{                                                                                       // Entry: Yoga 710
		.ident = "Lenovo Yoga 710",                                                     // Specific model label
		.matches = {                                                                    // Match criteria:
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),                                    // Must be Lenovo
			DMI_MATCH(DMI_PRODUCT_NAME, "Yoga 710"),                                // Exact name match
		},                                                                              // End matches
		.driver_data = (void *)&ideapad_8bit_reg6_cfg,                                  // Load reg6 config
	},                                                                                      // End entry
	{                                                                                       // Entry: IdeaPad 510s
		.ident = "Lenovo Ideapad 510s",                                                 // Specific model label
		.matches = {                                                                    // Match criteria:
			DMI_MATCH(DMI_SYS_VENDOR, "LENOVO"),                                    // Must be Lenovo
			DMI_MATCH(DMI_PRODUCT_NAME, "Ideapad 510s"),                            // Exact name match
		},                                                                              // End matches
		.driver_data = (void *)&ideapad_8bit_reg6_cfg,                                  // Load reg6 config
	},                                                                                      // End entry

	/* Family-Based Fallbacks */                                                            // General family matches
	{                                                                                       // Entry: Legion
